...
static uint8 simpleProfileChar1[2] = {0,1};
...
static uint8 simpleProfileChar4[SIMPLEPROFILE_CHAR4_LEN] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
static uint8 simpleProfileChar5[SIMPLEPROFILE_CHAR5_LEN] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
bStatus_t SimpleProfile_SetParameter( uint8 param, uint8 len, void *value )
{
  ...
  switch ( param )
  {
    case SIMPLEPROFILE_CHAR1:
      ...
      {
        VOID memcpy( simpleProfileChar1,value,sizeof (uint16));
    ...
    case SIMPLEPROFILE_CHAR2:
      if ( len == sizeof ( uint16 ) ) 
      {
         VOID memcpy( simpleProfileChar2,value,sizeof (uint16));
...
bStatus_t SimpleProfile_GetParameter( uint8 param, void *value )
{
  ...
  {
    case SIMPLEPROFILE_CHAR1:
      VOID memcpy( value, simpleProfileChar1, sizeof(uint16));
      //*((uint16*)value) = simpleProfileChar1;
      break;

    case SIMPLEPROFILE_CHAR2:
      VOID memcpy( value, simpleProfileChar2, sizeof(uint16));
    ...
    switch ( uuid )
    {
      ...
      case SIMPLEPROFILE_CHAR5_UUID:
        ...
        if ( status == SUCCESS )
        {
          ...
          pCurValue[4] = pValue[4];
          pCurValue[5] = pValue[5];
          pCurValue[6] = pValue[6];
          pCurValue[7] = pValue[7];
