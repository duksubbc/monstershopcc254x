...
static hidDevStatus_t *pHidDevStatus;
 ...
 * @return  None.
 */
void HidDev_Register( hidDevCfg_t *pCfg, hidDevCB_t *pCBs , hidDevStatus_t *pStatus )
{
  pHidDevCB = pCBs;
  pHidDevCfg = pCfg;
  pHidDevStatus = pStatus;
}
...
static void hidDevGapStateCB( gaprole_States_t newState )
{
  ...
  pHidDevStatus->status = hidDevGapState;
}
