...
#define HAL_BOARD_MONSTER_REV_B
...
#ifndef HAL_BOARD_MONSTER_REV_B
/* 1 - Blue */
#define LED1_BV                        BV(3)
...
#ifndef HAL_BOARD_MONSTER_REV_B
#define KEY_AB_PORT                    P1     
#define KEY_A_BV                       BV(4)
#define KEY_A_SBIT                     P1_4
#define KEY_A_POLARITY                 ACTIVE_HIGH

#define KEY_B_BV                       BV(6)
#define KEY_B_SBIT                     P1_6
#define KEY_B_POLARITY                 ACTIVE_HIGH

#define KEY_CD_PORT                    P0   
#define KEY_C_BV                       BV(1)
#define KEY_C_SBIT                     P0_1
#define KEY_C_POLARITY                 ACTIVE_HIGH
 
#define KEY_D_BV                       BV(4)
#define KEY_D_SBIT                     P0_4
#define KEY_D_POLARITY                 ACTIVE_HIGH

#define KEY_E_PORT                     P2  
#define KEY_E_BV                       BV(0)
#define KEY_E_SBIT                     P2_0
#define KEY_E_POLARITY                 ACTIVE_HIGH

#define PWR_SW_PORT         P2
#define PWR_SW_BV           BV(0)
#define PWR_SW_SBIT         P2_0
#define PWR_SW_DDR          P2DIR
#define PWR_SW_POLARITY     ACTIVE_HIGH

#define PWR_EN_PORT         P1
#define PWR_EN_BV           BV(7)
#define PWR_EN_SBIT         P1_7
#define PWR_EN_DDR          P1DIR

#else
   
#define KEY_A_PORT                     P1   
#define KEY_A_BV                       BV(4) //BV(5)
#define KEY_A_SBIT                     P1_4  //P1_5
#define KEY_A_POLARITY                 ACTIVE_HIGH

#define KEY_B_PORT                     P0   
#define KEY_B_BV                       BV(7) //BV(4)
#define KEY_B_SBIT                     P0_7  //P1_4
#define KEY_B_POLARITY                 ACTIVE_HIGH

#define KEY_C_PORT                     P1    
#define KEY_C_BV                       BV(5) //BV(0)
#define KEY_C_SBIT                     P1_4  //P0_0
#define KEY_C_POLARITY                 ACTIVE_HIGH

#define KEY_D_PORT                     P0   
#define KEY_D_BV                       BV(0) //BV(7)
#define KEY_D_SBIT                     P0_0  //P0_7
#define KEY_D_POLARITY                 ACTIVE_HIGH

#define KEY_E_PORT                     P0  
#define KEY_E_BV                       BV(4)
#define KEY_E_SBIT                     P0_4
#define KEY_E_DDR                      P0DIR  
#define KEY_E_POLARITY                 ACTIVE_HIGH

#define PWR_SW_PORT         P0
#define PWR_SW_BV           BV(4)
#define PWR_SW_SBIT         P0_4
#define PWR_SW_DDR          P0DIR
#define PWR_SW_POLARITY     ACTIVE_HIGH

#define PWR_EN_PORT         P2
#define PWR_EN_BV           BV(0)
#define PWR_EN_SBIT         P2_0
#define PWR_EN_DDR          P2DIR   
#endif
...
{                                                                              \
  ...
  LED1_DDR |= LED1_BV;                                                         \
  LED1_SBIT = 1;                                                               \
  PWR_EN_DDR &= ~PWR_EN_BV;     /* Set P1_7 as output */                       \
  P2DIR &= ~BV(0);          /* Unused pin as output */                         \
  P0DIR |= BV(6);          /* Unused pin as output */                          \
  P0DIR |= BV(7);          /* Unused pin as output */                          \
  P0INP =  0x4E;           /* Tri-state inputs */                              \
  P1INP |= BV(5);          /* Tri-state inputs */                              \
}
#else
/* Board Initialization */
#define HAL_BOARD_INIT()                                                       \
{                                                                              \
  ...
  LED1_SBIT = 1;                                                               \
  PWR_EN_DDR &= ~PWR_EN_BV;     /* Set P1_7 as output */                       \
  P0DIR |= BV(1);          /* Unused pin as output */                          \
  P0DIR |= BV(6);          /* Unused pin as output */                          \
  P1DIR |= BV(0);          /* Unused pin as output */                          \
  P1DIR |= BV(1);          /* Unused pin as output */                          \
  P1DIR |= BV(2);          /* Unused pin as output */                          \
  P1DIR |= BV(3);          /* Unused pin as output */                          \
  P0INP |= BV(0);          /* Tri-state inputs */                              \
  P0INP |= BV(4);          /* Tri-state inputs */                              \
  P0INP |= BV(7);          /* Tri-state inputs */                              \
  P1INP |= BV(4);          /* Tri-state inputs */                              \
  P1INP |= BV(5);          /* Tri-state inputs */                              \
}
#endif
/* Debounce */
